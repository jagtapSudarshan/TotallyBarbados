...
- (void)defaultSettings
{
    ...
    self.yPositionOfTabView = 40.f;
  self.tabsViewBackgroundColor = [UIColor yellowColor];//kTabsViewBackgroundColor;
...
- (void)defaultSetUp
{
    ...
    if (!self.tabsView) {
      ...
      self.tabsView.backgroundColor = [UIColor blackColor];//self.tabsViewBackgroundColor;
    ...
    for (NSUInteger i = 0; i < self.tabCount; i++) {
      ...
      frame.size.width = width/3;//[self.dataSource widthOfTabViewWithIndex:i];
        tabView.frame = frame;
    ...
    if (!self.contentView) {
      ...
      self.contentView.backgroundColor = [UIColor blueColor];//kContentViewBackgroundColor;
